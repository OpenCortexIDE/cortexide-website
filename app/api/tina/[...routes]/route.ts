...
async function getHandler() {
  ...
  if (!databaseClient) {
    try {
      ...
      // Use Function constructor with eval to prevent webpack from statically analyzing this
      // This ensures webpack doesn't try to bundle a file that doesn't exist at build time
