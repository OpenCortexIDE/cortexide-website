...
async function getHandler() {
  ...
  if (!databaseClient) {
    try {
      // Try to require the generated database client
      // The file will be generated by 'tinacms build' before 'next build' runs
      // Using require.resolve to find the file, then require it
      const dbPath = require.resolve('../../../../../tina/__generated__/databaseClient')
      databaseClient = require(dbPath).default
    } catch (e) {
      // If generated client doesn't exist, try using path-based require
      try {
